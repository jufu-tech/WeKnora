export default {
  ...
  integrations: {
    ...
    claw: {
      ...
      subtitle: 'Импорт документов и гибридный поиск (вектор + ключевые слова) через REST API Easy RAG — загрузки, URL, Markdown и поиск.',
      ...
      ecosystemNote: 'Skill размещён на ClawHub ({\'@\'}lyingbug/easyrag). Полная документация API — на странице ClawHub.',
      installCta: 'Открыть ClawHub',
      installCtaHint: 'Установка Easy RAG Skill · откроется в новой вкладке',
      ...
      steps: {
        ...
        env: {
          ...
          desc: 'Задайте EASYRAG_BASE_URL и EASYRAG_API_KEY в shell или ~/.zshrc / ~/.bashrc. Пример ниже использует текущий API URL — замените API Key на фактическое значение.'
        },
        api: {
    ...
    chrome: {
      ...
      subtitle: 'Для self-hosted Easy RAG: вопросы в боковой панели, клиппинг страниц и Markdown-заметки в базы знаний прямо при просмотре.',
      ...
      steps: {
        ...
        port: {
          ...
          desc: 'В Easy RAG Desktop задайте фиксированный порт API (например 37841) в API-информации.'
        },
        api: {
    ...
    api: {
      ...
      capabilityManageModelsHint: 'Управление конфигурациями моделей, учётными данными, проверками подключения и данными Easy RAG Cloud.',
      ...
      hmacSecretDesc: 'Тот же secret, что в Easy RAG; только для подписи JWT на backend — не отправляйте его в заголовке запроса.',
      ...
      signedRequestStep0: '# 0. Подпишите JWT на backend (HS256, aud=easyrag, sub=ID пользователя, tenant_id={tenantId}, exp не более 24 ч)',
  ...
  kbSettings: {
    parser: {
      ...
      engines: {
        ...
        weknoracloud: {
          name: 'Easy RAG Cloud',
          desc: 'Парсинг документов через Easy RAG Cloud'
        },
        paddleocr_vl_cloud: {
  ...
  system: {
    ...
    versionDescription: 'Версия сервиса приложения (Easy RAG APP)',
    frontendVersionLabel: 'Версия UI',
    frontendVersionDescription: 'Версия сборки UI (Easy RAG UI)',
  ...
  createChat: {
    title: 'Привет, я Easy RAG — ваши знания всегда под рукой',
  ...
  auth: {
    ...
    registerSubtitle: 'Создайте аккаунт и начните работу с Easy RAG',
  ...
  settings: {
    ...
    weknoraCloud: {
      ...
      description: 'Настройте учётные данные APPID и APPSECRET для Easy RAG Cloud. Данные используются для модельных сервисов и движка парсинга документов.',
      ...
      expired: 'Учётные данные Easy RAG Cloud истекли',
      ...
      appIdLabel: 'APPID',
      appIdDesc: 'ID приложения Easy RAG Cloud',
      appIdPlaceholder: 'Введите APPID',
      appSecretLabel: 'APPSECRET',
      appSecretDesc: 'Секрет приложения Easy RAG Cloud',
      ...
      modelsSection: {
        ...
        descReady: 'Зарегистрируйте четыре стандартные модели Easy RAG Cloud для чата, поиска, реранкинга и зрения.',
  ...
  newUserGuide: {
    ...
    steps: {
      ...
      knowledge: {
        ...
        desc: 'С этого всё начинается: загружайте документы, веб-страницы или FAQ, и Easy RAG автоматически разберёт и проиндексирует их. Нажмите здесь, чтобы открыть базы знаний.'
      },
      welcome: {
        title: 'Добро пожаловать в Easy RAG',
